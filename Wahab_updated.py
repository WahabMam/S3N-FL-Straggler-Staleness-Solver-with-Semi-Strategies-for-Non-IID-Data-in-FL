...
if __name__ == '__main__':
    ...
    save_dir_1 = f"MAK2_logs/long_run/FIRST_Completed/{args.stragglers_percent}strg_{SYNC}sync_Time"
    ...
    filename = f"MAK_log_{current_time}.csv"
    save_dir2 = f"MAK2_logs/FIRST_Exception/{args.stragglers_percent}strg_{SYNC}sync_Time"
